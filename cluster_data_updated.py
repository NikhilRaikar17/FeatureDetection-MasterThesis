...
import feature_generation_updated
...
def ClusterVariations():
    ...
    # Spherical K-means Clustering Process
    ...
    # Affinity Propogation Clustering process
...
def FeatureExtraction():
    ...
    for i, j in zip(a.values(), a.keys()):
        ...
        # feature_generation_updated.named_Entity(""" """.join(clus))
...
if __name__ == "__main__":
    ...
    # Clustering
    ClusterVariations()
    # The main function which handles all Feature Extraction
    FeatureExtraction()
...
feature = ["When the alarm system is activated, this is indicated by the light of the LED.",
...
kmeans = clustering.cluster_texts(format,clusters=7)
# kmeans = clustering.cluster_texts(tree1,clusters=5)
